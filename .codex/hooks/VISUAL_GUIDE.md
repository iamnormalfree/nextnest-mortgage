...
│     └─ Exit code: 2 (prevent tool execution)                       │
...
| 🟡 MEDIUM | ✅ YES | ❌ NO | 🛑 BLOCK | Must delegate | 2 |
| 🔴 HEAVY | Any | ❌ NO | 🛑 BLOCK | Orchestrator only | 2 |
| 🔴 FULL | Any | ❌ NO | 🛑 BLOCK | Orchestrator only | 2 |
| 🔵 AUTO | ✅ YES | ❌ NO | 🛑 BLOCK | Router orchestrator | 2 |
