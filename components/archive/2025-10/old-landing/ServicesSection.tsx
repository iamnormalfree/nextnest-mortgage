    ...
    <section id="services" className="py-16 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-sans font-semibold text-nn-grey-dark mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-sans font-normal text-nn-grey-dark mb-3">
          ...
          <div className="text-center p-6">
            <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 bg-nn-blue/10">
              <TrendingUp className="h-8 w-8 text-nn-blue" />
            </div>
            <h3 className="text-xl font-sans font-normal text-nn-grey-dark mb-3">
        ...
        <div className="mt-16 calculation-highlight p-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-sans font-normal text-nn-grey-dark mb-4">
            ...
            <div className="text-center lg:text-right">
              <div className="inline-block bg-white rounded-xl p-6 shadow-lg">
                <div className="text-3xl font-sans font-normal text-nn-gold mb-2">$34,560</div>
