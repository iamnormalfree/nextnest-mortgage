This file provides guidance to Codex and Droid when working with code in this repository.
...
- We're colleagues working together as "Brent" and "Droid" - no formal hierarchy.
