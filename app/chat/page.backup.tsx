...
import MetricsRow from '@/components/chat/MetricsRow'
import SummaryInsightBanner from '@/components/chat/SummaryInsightBanner'
          ...
          <>
            ...
            {!isLoadingBroker && broker && (
              <BrokerProfile
                ...
                brokerPersonality={broker.personalityType}
                isOnline={true}
                isTyping={false}
              />
            )}
